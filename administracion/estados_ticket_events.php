...
//Page_BeforeInitialize @1-45BF468E
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $estados_ticket; //Compatibility
...
//Page_AfterInitialize @1-3116222D
