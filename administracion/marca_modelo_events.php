...
function BindEvents()
{
    ...
    $makes_models->CCSEvents["BeforeShow"] = "makes_models_BeforeShow";
...
//Close Panel2_BeforeShow @15-AE7F9FB3
    return $Panel2_BeforeShow;
}
//End Close Panel2_BeforeShow

//makes_models_BeforeShow @86-D4C3C061
function makes_models_BeforeShow(& $sender)
{
    $makes_models_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $makes_models; //Compatibility
//End makes_models_BeforeShow

//Custom Code @128-2A29BDB7
// -------------------------
    $makes_models->make_id->SetValue(CCGetParam('make_id'));
    $db = new clsDBminseg();
    $makes_models->marca->SetValue(CCDLookUp("make_descrip","makes","make_id = ".CCGetParam('make_id'),$db));
    $db->close();
// -------------------------
//End Custom Code

//Close makes_models_BeforeShow @86-2738E2EB
    return $makes_models_BeforeShow;
}
//End Close makes_models_BeforeShow

//Panel3_BeforeShow @73-34D6D0C7
...
//Close Panel3_BeforeShow @73-33707EC5
    return $Panel3_BeforeShow;
}
//End Close Panel3_BeforeShow

//Panel4_BeforeShow @84-EF0AEAA3
...
//Close Panel4_BeforeShow @84-56BDD405
...
//Panel1UpdatePanel1 Page BeforeShow @23-546243CA
...
//Page_BeforeInitialize @1-A4E8ED7F
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $marca_modelo; //Compatibility
...
//Panel1UpdatePanel1 PageBeforeInitialize @23-37A82194
...
//Page_AfterInitialize @1-A59619A8
...
//Panel1UpdatePanel1 Page BeforeShow @23-9F5F0EA1
    global $CCSFormFilter;
...
//Panel1UpdatePanel1 PageBeforeOutput @23-0DFF2749
...
//Panel1UpdatePanel1 PageBeforeUnload @23-483BFCB6
