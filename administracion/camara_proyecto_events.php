...
//Page_BeforeInitialize @1-052B36D7
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $camara_proyecto; //Compatibility
...
//Page_AfterInitialize @1-4A806DE1
...
// -------------------------
	...
	if ( APP_ENVIRONMENT == 'test' ) {
	    $Component->app_environment_class->SetValue('app-environment-test');
	}
// -------------------------
//End Custom Code
