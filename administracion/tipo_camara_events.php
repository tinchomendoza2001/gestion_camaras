...
//Page_BeforeInitialize @1-7B61376B
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $tipo_camara; //Compatibility
...
//Page_AfterInitialize @1-DEE4E62A
