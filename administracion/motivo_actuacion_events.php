...
//Page_BeforeInitialize @1-68C8A820
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $motivo_actuacion; //Compatibility
...
//Page_AfterInitialize @1-A73D96E2
