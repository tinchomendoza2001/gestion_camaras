...
//Close Panel2_BeforeShow @21-AE7F9FB3
...
//Page_BeforeInitialize @1-A2B4DB84
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $prioridad_ticket; //Compatibility
...
//Page_AfterInitialize @1-6D41E546
